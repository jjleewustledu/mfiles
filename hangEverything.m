...
ho1gauss                   = peekPerfusion(idx, 'ho1',     0, [3.4,1], 'dip');
oc1                        = peekPerfusion(idx, 'oc1',     0, [0,0], 'dip');
oc1gauss                   = peekPerfusion(idx, 'oc1',     0, [3.4,1], 'dip');
oo1                        = peekPerfusion(idx, 'oo1',     0, [0,0], 'dip');
oo1gauss                   = peekPerfusion(idx, 'oo1',     0, [3.4,1], 'dip');
...
oo1gauss_rois              = peekOverlayROIs(oo1gauss, rois, 'oo1');
...
dipfig(55,'ho1',          [dipinit_ss-pos.*[1,0],ws]); dipmapping(55,'lin',       'slice',sl);
dipfig(54,'ho1gauss',     [dipinit_ss-pos.*[1,1],ws]); dipmapping(54,'lin',       'slice',sl);
dipfig(58,'ho1gauss_rois',[dipinit_ss-pos.*[2,2],ws]); dipmapping(58,'lin',       'slice',sl);
dipfig(55,'oc1',          [dipinit_ss-pos.*[1,2],ws]); dipmapping(55,'lin',       'slice',sl);
dipfig(54,'oc1gauss',     [dipinit_ss-pos.*[1,3],ws]); dipmapping(54,'lin',       'slice',sl);
dipfig(55,'oo1',          [dipinit_ss-pos.*[2,0],ws]); dipmapping(55,'lin',       'slice',sl);
dipfig(54,'oo1gauss',     [dipinit_ss-pos.*[2,1],ws]); dipmapping(54,'lin',       'slice',sl);
dipfig(59,'t1s',          [dipinit_ss-pos.*[0,0],ws]); dipmapping(59,'lin',       'slice',sl);
dipfig(60,'t1s_rois',     [dipinit_ss-pos.*[0,1],ws]); dipmapping(60,'lin',       'slice',sl);
