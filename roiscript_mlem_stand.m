...
cbfmlem = readcollection('t:\perfusion\asnr3\pt3\MLEM\standard\gvFitNone\mle_cbf_net_x872_y382.dat','double',512,1024,1);
cbvmlem = readcollection('t:\perfusion\asnr3\pt3\MLEM\standard\gvFitNone\mle_cbv_net_x872_y382.dat','double',512,1024,1);
mttmlem = readcollection('t:\perfusion\asnr3\pt3\MLEM\standard\gvFitNone\mle_mtt_net_x872_y382.dat','double',512,1024,1);
...
study(:,:,1) = scrubNaNs(cbfmlem(:,:,0));
study(:,:,2) = scrubNaNs(cbvmlem(:,:,0));
study(:,:,3) = scrubNaNs(mttmlem(:,:,0));
study(:,:,4) = cbfpet(:,:,0);
study(:,:,5) = cbvpet(:,:,0);
study(:,:,6) = mttpet(:,:,0);
