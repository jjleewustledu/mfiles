...
for i=1:size(data,2) %write varnames for each column
    if i<=size(varnames,1) && ischar(varnames{i}) %use input varnames
...
%these lines reformat DOT-Variables to 'normal' numerical values
