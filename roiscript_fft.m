...
cbffft = readcollection('t:\perfusion\asnr2\standard\pt3\fft_cbf_0.dat','double',512,1024,1);
cbvfft = readcollection('t:\perfusion\asnr2\standard\pt3\fft_cbv_0.dat','double',512,1024,1);
mttfft = readcollection('t:\perfusion\asnr2\standard\pt3\fft_mtt_0.dat','double',512,1024,1);
...
study(:,:,1) = scrubNaNs(cbffft(:,:,0));
study(:,:,2) = scrubNaNs(cbvfft(:,:,0));
study(:,:,3) = scrubNaNs(mttfft(:,:,0));
study(:,:,4) = cbfpet(:,:,0);
study(:,:,5) = cbvpet(:,:,0);
study(:,:,6) = mttpet(:,:,0);
