%PEEKCOORDS3_WMREF
%
% Usage:  theCoords = peekCoords3_wmref(kindRoi, kindImg, side, moment, white_matter_ref)
%
...
function theCoords = peekCoords3_wmref(kindRoi, kindImg, side, moment, white_matter_ref)
