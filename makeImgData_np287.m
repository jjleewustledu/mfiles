...
%
% Usage:    idat = makeImgData_np287(pid)
%
...
function idat = makeImgData_np287(pid, metric)
	...
	idat.showCoeffVariation      = true;

	idat.masks                   = false;
    
    idat.images{1}.modality      = 'pet';
    idat.images{1}.dipImage      = newim(db('sizes3d', idat.study));
    idat.images{1}.scaleFactor   = 1;
    [flowA flowB]                = petFlows(vcnum_to_pnum(pid));
    ...
    switch (lower(metric))
        case {'cbf','f'}
            ...
            idat.images{1}.supValue      = 3;
            
            idat.images{2}.metric        = 'F';
            idat.images{2}.imageName     = 'MR LAIF CBF';  
            idat.images{2}.imageSafeName = 'MR LAIF CBF';
            idat.images{2}.supValue      = idat.images{1}.supValue;
            
            idat.images{3}.metric        = 'CBF';
            idat.images{3}.imageName     = 'MR MLEM CBF';   
            idat.images{3}.imageSafeName = 'MR MLEM CBF';
        ...
        case {'cbv'}
            ...
            idat.images{2}.imageName     = 'MR LAIF CBV';  
            idat.images{2}.imageSafeName = 'MR LAIF CBV';
            idat.images{2}.supValue      = idat.images{1}.supValue;
            
            idat.images{3}.metric        = 'CBV';
            idat.images{3}.imageName     = 'MR MLEM CBV';   
            idat.images{3}.imageSafeName = 'MR MLEM CBV';
            idat.images{3}.supValue      = idat.images{1}.supValue;
        ...
        case {'mtt'}
            ...
            idat.images{2}.imageName     = 'MR LAIF MTT';  
            idat.images{2}.imageSafeName = 'MR LAIF MTT';
            idat.images{2}.units         = 'sec';
            idat.images{2}.supValue      = idat.images{1}.supValue;
            
            idat.images{3}.metric        = 'mtt';
            idat.images{3}.imageName     = 'MR MLEM MTT';   
            idat.images{3}.imageSafeName = 'MR MLEM MTT';
            idat.images{3}.units         = 'sec';
            idat.images{3}.supValue      = idat.images{1}.supValue;
            
        otherwise
            error(['makeImgData_np287:  could not recognize metric ' metric]);
    end
  
    for i = 1:3
        idat = readImage(idat, i);
        idat.images{i}.dipImage = ...
            idat.images{i}.scaleFactor * idat.images{i}.dipImage .* ...
            (idat.images{i}.dipImage < idat.images{i}.supValue);
    end

    for i = 1:3
         idat.images{i}.study = 'np287';
