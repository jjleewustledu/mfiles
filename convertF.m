% CONVERTF
%
% Usage:    Fout = convertF(Fin, intag, outtag, cfun)
%
%           Fin:      double matlab column vector
...
function Fout = convertF(Fin, intag, outtag, cfun, petCbf, extraTag, matfil)
...
Fout = (y_all - cfun.p2*ones(size(y_all,1),1))./cfun.p1;
return;
