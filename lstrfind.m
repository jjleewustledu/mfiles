...
%% LSTRFIND always returns a logical scalar.  Consider alternatives:  contains, endsWith, matches, strcmp, startsWith.
%  Returns:
%      tf: true if the string pattern is found anywhere within the text, text may be cell-arrayed.
%      tf: true if any element of the cell-arrayed pattern is found in non-arrayed text.
