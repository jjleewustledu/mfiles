%%TEST_NILIO_READ4DFP reads floating-point data in Avi Snyder's 4dfp-format
%
% SYNOPSIS:
...
function image_out = test_nilio_read4dfp(filename, endian, type, Dim1, Dim2, Dim3, Dim4, Offset4)
