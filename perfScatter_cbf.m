function perfScatter_cbf(pt, hemisphere, concModel, intercept, slope)
...
if strcmp(concModel, 'Cumulants')
    ...
    elseif (pt == 3)
        if (strcmp(hemisphere, 'rhs'))
            perfScatter(3, 'rhs', perfParam, deconvMethod, concModel, 0.35, 65, 1185, intercept, slope);
        else
            perfScatter(3, 'lhs', perfParam, deconvMethod, concModel, 0.35, 65, 994, intercept, slope); 
        end
    elseif (pt == 4)
        if (strcmp(hemisphere, 'rhs'))
    ...
    if (pt == 1)
        if (strcmp(hemisphere, 'rhs'))
            ...
            perfScatter(1, 'lhs', perfParam, deconvMethod, concModel, 0.35, 65, ...
                555, intercept, slope); % 591 crashes
        end
    elseif (pt == 2)
        if (strcmp(hemisphere, 'rhs'))
    ...
    elseif (pt == 3)
        if (strcmp(hemisphere, 'rhs'))
            ...
            perfScatter(3, 'lhs', perfParam, deconvMethod, concModel, 0.3, 65, 994, intercept, slope); 
        end
    elseif (pt == 4)
        if (strcmp(hemisphere, 'rhs'))
            perfScatter(4, 'rhs', perfParam, deconvMethod, concModel, 0.35, 55, ...
