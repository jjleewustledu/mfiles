function map_vol_to_surface_shimony(volumepattern,hem,mappingtype,space)
...
%
%
% example for Josh: map_vol_to_surface_shimony('/data/nil-bluearc/shimony/blah/fileName.4dfp.img','both','ribbon-constrained','711-2B')
%
% Written by E. Gordon 2/15/13

%directory the surfaces are in
%surfdir = '/data/cn4/evan/fsaverage_LR32k/';
surfdir = '/data/nil-bluearc/shimony/Matlab/Surfaces/';

%where workbench is installed
workbenchdir = '/data/nil-bluearc/shimony/Matlab/workbench/bin_linux64/';

%where the 711-2B to MNI tranform is located on the server
T4_7112B_to_MNI = fullfile(getenv('RELEASE'), '711-2B_to_MNI152lin_T1_t4');
...
%         system(['t4img_4dfp ' T4_7112B_to_MNI ' Temp.4dfp.img Temp_MNI.4dfp.img']) %FOR sinc interpolation?
        system(['t4img_4dfp ' T4_7112B_to_MNI ' Temp.4dfp.img Temp_MNI.4dfp.img -n']) %FOR nearest neighbor interpolation
