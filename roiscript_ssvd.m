...
cbfssvd = readcollection('t:\perfusion\asnr3\pt3\ssvd\standard\mle_cbf_net_x872_y382.dat','double',512,1024,1);
cbvssvd = readcollection('t:\perfusion\asnr3\pt3\ssvd\standard\mle_cbv_net_x872_y382.dat','double',512,1024,1);
mttssvd = readcollection('t:\perfusion\asnr3\pt3\ssvd\standard\mle_mtt_net_x872_y382.dat','double',512,1024,1);
...
study(:,:,1) = scrubNaNs(cbfssvd(:,:,0));
study(:,:,2) = scrubNaNs(cbvssvd(:,:,0));
study(:,:,3) = scrubNaNs(mttssvd(:,:,0));
study(:,:,4) = cbfpet(:,:,0);
study(:,:,5) = cbvpet(:,:,0);
study(:,:,6) = mttpet(:,:,0);
