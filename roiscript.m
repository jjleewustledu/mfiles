...
cbfcum = readcollection('t:\perfusion\asnr3\pt3\MLEM\cumulants\aifIpsilateral\mle_cbf_net_x916_y384.dat','double',512,1024,1);
cbvcum = readcollection('t:\perfusion\asnr3\pt3\MLEM\cumulants\aifIpsilateral\mle_cbv_net_x916_y384.dat','double',512,1024,1);
mttcum = readcollection('t:\perfusion\asnr3\pt3\MLEM\cumulants\aifIpsilateral\mle_mtt_net_x916_y384.dat','double',512,1024,1);
cbfstand = readcollection('t:\perfusion\asnr3\pt3\MLEM\standard\aifIpsilateral\mle_cbf_net_x916_y384.dat','double',512,1024,1);
cbvstand = readcollection('t:\perfusion\asnr3\pt3\MLEM\standard\aifIpsilateral\mle_cbv_net_x916_y384.dat','double',512,1024,1);
mttstand = readcollection('t:\perfusion\asnr3\pt3\MLEM\standard\aifIpsilateral\mle_mtt_net_x916_y384.dat','double',512,1024,1);
...
excel_lhs_mymean = zeros(15, 9);
excel_lhs_mystd = zeros(15, 9);
excel_rhs_mymean = zeros(15, 9);
excel_rhs_mystd = zeros(15, 9);
...
petabscissas(1:15,1) = excel_lhs_mymean(:,7);
petabscissas(16:30,1) = excel_rhs_mymean(:,7);
petabscissas(1:15,2) = excel_lhs_mymean(:,8);
petabscissas(16:30,2) = excel_rhs_mymean(:,8);
petabscissas(1:15,3) = excel_lhs_mymean(:,9);
petabscissas(16:30,3) = excel_rhs_mymean(:,9);
petabscissas(1:15,4) = excel_lhs_mymean(:,7);
petabscissas(16:30,4) = excel_rhs_mymean(:,7);
petabscissas(1:15,5) = excel_lhs_mymean(:,8);
petabscissas(16:30,5) = excel_rhs_mymean(:,8);
petabscissas(1:15,6) = excel_lhs_mymean(:,9);
petabscissas(16:30,6) = excel_rhs_mymean(:,9);

mrordinates = zeros(30, 6);
...
mrordinates(1:15,4) = excel_lhs_mymean(:,4);
mrordinates(16:30,4) = excel_rhs_mymean(:,4);
mrordinates(1:15,5) = excel_lhs_mymean(:,5);
mrordinates(16:30,5) = excel_rhs_mymean(:,5);
mrordinates(1:15,6) = excel_lhs_mymean(:,6);
mrordinates(16:30,6) = excel_rhs_mymean(:,6);
