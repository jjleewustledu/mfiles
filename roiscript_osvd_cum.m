...
cbfosvd = readcollection('t:\perfusion\asnr2\cumulants\pt3\osvd_cbf_0.dat','double',512,1024,1);
cbvosvd = readcollection('t:\perfusion\asnr2\cumulants\pt3\osvd_cbf_0.dat','double',512,1024,1);
mttosvd = readcollection('t:\perfusion\asnr2\cumulants\pt3\osvd_cbf_0.dat','double',512,1024,1);
...
study(:,:,1) = scrubNaNs(cbfosvd(:,:,0));
study(:,:,2) = scrubNaNs(cbvosvd(:,:,0));
study(:,:,3) = scrubNaNs(mttosvd(:,:,0));
study(:,:,4) = cbfpet(:,:,0);
study(:,:,5) = cbvpet(:,:,0);
study(:,:,6) = mttpet(:,:,0);
